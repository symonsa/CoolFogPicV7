...
start_main(void) {
    ...
    { PORTAbits.RA1 = (1); fault_flags.mainPumpBit = (1);};
    monitor_pump_run();
    ...
    if (!( PORTAbits.RA5)) {
        ...
        if (!timer_events[EventLowFogPressure].active) {
            timer_events[EventLowFogPressure].flag_bit = 0;
            timer_events[EventLowFogPressure].flag_data = (3*(4000000/256/4/256));
            enable_callback(EventLowFogPressure, (30*(4000000/256/4/256)));
        }
    }
