...
# 13 "EventFaultStateLed.c"
 ...
 || fault_flags.lwp_fault
    ...
    enable_callback (EventFaultStateLED, ((4000000/256/4/256)/4));
  }
  else {
 ...
 enable_callback (EventFaultStateLED, ((4000000/256/4/256)*1));
      }
    }
    else {
