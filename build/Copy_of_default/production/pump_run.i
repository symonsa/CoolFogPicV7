...
# 15 "pump_run.c"
 ...
 if (!( PORTAbits.RA5)) {
    ...
    if (!timer_events[EventLowFogPressure].active) {
      timer_events[EventLowFogPressure].flag_bit = 1;
      timer_events[EventLowFogPressure].flag_data = (15*(4000000/256/4/256));
      enable_callback (EventLowFogPressure, (15*(4000000/256/4/256)));
    }
...
monitor_pump_run(void){
    ...
    if (( (!PORTCbits.RC1) || (combinedZones != 0) )) {
      ...
      timer_events[EventRunSignalDebounce].flag_bit = 0;
      timer_events[EventRunSignalDebounce].next_state = shutdownState;
      enable_callback (EventRunSignalDebounce, ((4000000/256/4/256)/2));
    }
  ...
  if (( !PORTCbits.RC2)) {
      ...
      enable_callback (EventPODebounce, ((4000000/256/4/256)/2));
    }
  ...
  if (!( PORTAbits.RA4)) {
    ...
    if (!timer_events[EventLowWaterLevel].active) {
      timer_events[EventLowWaterLevel].flag_bit = 1;
      timer_events[EventLowWaterLevel].flag_data = 0;
      enable_callback (EventLowWaterLevel, (3*(4000000/256/4/256)));
  ...
  if (fault_flags.wpOkBit) {
    ...
    if (!timer_events[EventLowWaterPressure].active) {
      ...
      enable_callback (EventLowWaterPressure, (3*(4000000/256/4/256)));
    }
  }
