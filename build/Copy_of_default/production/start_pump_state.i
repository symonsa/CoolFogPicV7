...
start_pump ()
{
  ...
  if (( PORTAbits.RA4)) {
    ...
    enable_callback (EventLowWaterLevel, (30*(4000000/256/4/256)));
    return;
  }
...
# 41 "start_pump_state.c"
 ...
 enable_callback (EventLowWaterPressure, (30*(4000000/256/4/256)));
