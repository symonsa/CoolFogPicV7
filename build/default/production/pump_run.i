...
# 15 "pump_run.c"
 ...
 if (!( PORTAbits.RA5)) {
    ...
    if (!timer_events[EventLowFogPressure].active) {
      ...
      timer_events[EventLowFogPressure].flag_data = (15*(8000000/256/4/256));
      enable_callback (EventLowFogPressure, (15*(8000000/256/4/256)));
    }
...
monitor_pump_run(void){
    ...
    if (( (!PORTBbits.RB3) || (zones != 0) )) {
      ...
      enable_callback (EventRunSignalDebounce, ((8000000/256/4/256)/2));
    }
  ...
  if (( !PORTBbits.RB4)) {
      ...
      enable_callback (EventPODebounce, ((8000000/256/4/256)/2));
    }
  ...
  if (!( PORTAbits.RA4)) {
    ...
    if (!timer_events[EventLowWaterLevel].active) {
      ...
      enable_callback (EventLowWaterLevel, (3*(8000000/256/4/256)));
  ...
  if (fault_flags.wpOkBit) {
    ...
    if (!timer_events[EventLowWaterPressure].active) {
      ...
      enable_callback (EventLowWaterPressure, (3*(8000000/256/4/256)));
    }
  }
